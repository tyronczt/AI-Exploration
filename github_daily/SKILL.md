...
### 第四步：选择模板并组装数据生成 HTML

本技能提供两套模板，根据用户偏好或场景选择：

| 模板 | 文件 | 风格 | 适用场景 |
|------|------|------|----------|
| 浅色博客 | [template.html](template.html) | 白底卡片、清新排版 | 正式报告、邮件分享、文档归档 |
| 暗色仪表盘 | [template-dark.html](template-dark.html) | 深色主题、金银牌、趋势条 | 技术社区、个人博客、大屏展示 |

**默认使用暗色模板（template-dark.html）**，除非用户明确要求浅色风格。
...
1. 文件名：`github-trending-YYYY-MM-DD.html`
2. 保存到用户工作目录
...
- 浅色博客模板：[template.html](template.html)
- 暗色仪表盘模板：[template-dark.html](template-dark.html)
